...
SDL_SetColorKey(objet1->img,SDL_SRCCOLORKEY,SDL_MapRGB(objet1->img->format,255,255,255));

 objet2->img=IMG_Load("detective.png") ;
 objet2->pos.x=posXobj2 ;
 objet2->pos.y=posYobj2 ;
SDL_SetColorKey(objet2->img,SDL_SRCCOLORKEY,SDL_MapRGB(objet2->img->format,255,255,255));
}
...
int verif_collision ( Objet *objet1,Objet *objet2,float D1 )
{
  ...
  D2=objet1->c.rayon + objet2->c.rayon-120 ;
